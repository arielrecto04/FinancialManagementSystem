        ...
        <>
            ...
            {user.role === 'admin' && (
                <>
                    ...
                    <NavLink href={route('accounting.dashboard')} active={route().current('accounting.*')}>
                        Accounting
                    </NavLink>
                </>
            )}
        ...
        <>
            ...
            {user.role === 'admin' && (
                <div className="space-y-1">
                    ...
                    <ResponsiveNavLink href={route('accounting.dashboard')} active={route().current('accounting.*')}>
                        Accounting
                    </ResponsiveNavLink>
                </div>
            )}
